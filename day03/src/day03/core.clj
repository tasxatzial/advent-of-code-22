...
(defn rucksacks->compartments
  "Partitions a sequence of rucksacks into compartments. Returns a sequence that has
  the following structure: (((left compartment chars) (right compartment chars)), ...)"
  [rucksacks]
...
(defn rucksacks->grouped-by-3
  "Partitions a sequence of rucksacks into groups of 3. Returns a sequence that has
  the following structure: ((rucksack1 rucksack2 rucksack3), ...)"
  [rucksacks]
